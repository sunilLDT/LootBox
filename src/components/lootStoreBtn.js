    ...
    <svg width="147px" height="32px" viewBox="0 0 147 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Group-10">
                ...
                <g id="Group-14-Copy" transform="translate(43.000000, 8.000000)" fill="#FFFFFF" font-family="Avenir-Heavy, Avenir" font-size="12" font-weight="600" line-spacing="16">
                    <g id="Group-2-Copy-2" transform="translate(0.935780, 0.000000)">
                        <text id="Loot-Store">
                            <tspan x="0.804220183" y="12">Loot Store</tspan>
                        </text>
                    </g>
                </g>
            </g>

      ...
      {packageDetails ? (
        <View>
          ...
          <ImageBackground
            ...
            <TouchableOpacity onPress={() => openClose(props.data.item_id)}>
              <View
                style={{
                  flexDirection: 'row',
                  justifyContent: 'space-around',
                ...
                <Text
                  ...
                  {props.data.name
                    ? props.data.name.substring(0, maxlimit - 3) + '...'
                    : props.data.name.substring(0, maxlimit - 3) + '...'}
                </Text>
                <Text
                  style={{
        ...
        <View>
          <View
            ...
            <View style={{flexDirection: 'row', justifyContent: 'flex-start'}}>
              <Text style={{fontSize: 14, color: '#D2D7F9', fontWeight: '300'}}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  props.navigation.navigate('ItemListing', {
                    ...
                    selectedSubCategory: props.data,
                  });
                }}>
                <Text
                  style={{
                    ...
                    <ImageBackground
                      ...
                      <View
                        ...
                        <Text
                          ...
                          {processer.name
                            ? processer.name.substring(0, maxlimit - 3) + '...'
                            : processer.name.substring(0, maxlimit - 3) + '...'}
                        </Text>
                        <Text
                          style={{
